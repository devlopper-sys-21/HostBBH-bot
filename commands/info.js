...
module.exports = {
    ...
    execute(message, args){
       ...
       .addField("__Competetive League__", "*BHH Strucid League* was created to help grow the competitive scene and so better the community. for more informations about the league you can go to #CompInfos channel.")
